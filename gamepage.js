...
function send()
{
    ...
    sl = lower.charAt(1);
    console.log("Second Letter is... " + sl)

    index_last = lower.length - 1;
    last = lower.charAt(index_last)
    console.log("Last letter is... " + last)

    index_middle = Math.floor(lower.length/2)
    middle = lower.charAt(index_middle)
    console.log("Middle letter is... " + middle)

    o1 = lower.replace(sl,"_")
    o2 = o1.replace(middle, "_")
    o3 = o2.replace(last, "_")
    console.log(o3)
